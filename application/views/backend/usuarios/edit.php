                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>administrador/usuarios/update" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="dni" name="dni" class="form-control" minlength="8" maxlength="8" value="<?php echo $usuario->dni;?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="terminal" id="terminal" class="form-control">
                                    <?php foreach($terminales as $terminal):?>
                                        <option value="<?php echo $terminal->id;?>" <?php echo $terminal->id == $usuario->terminal_id ? "selected":"";?>><?php echo $terminal->ciudad;?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                            <div class="form-group">
