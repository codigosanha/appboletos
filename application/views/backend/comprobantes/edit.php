                            ...
                            <div class="form-group">
                                ...
                                <select name="terminal" id="terminal" class="form-control" required>
                                    ...
                                    <?php foreach ($terminales as $terminal): ?>
                                        <option value="<?php echo $terminal->id;?>" <?php echo $terminal->id == $comprobante->terminal_id ? "selected":""; ?>><?php echo $terminal->ciudad;?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="tipocomprobante" id="tipocomprobante" class="form-control" required>
                                    ...
                                    <?php foreach ($tipocomprobantes as $tipocomprobante): ?>
                                        <option value="<?php echo $tipocomprobante->id;?>" <?php echo $tipocomprobante->id == $comprobante->tipo_comprobante_id ? "selected":""; ?>><?php echo $tipocomprobante->nombre;?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="serie">Serie:</label>
                                <input type="text" class="form-control" id="serie" name="serie" value="<?php echo $comprobante->serie; ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="igv">IGV:</label>
                                <input type="text" class="form-control" id="igv" name="igv" value="<?php echo $comprobante->igv; ?>" required>
                            </div>
                            <div class="form-group">
